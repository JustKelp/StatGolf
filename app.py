...
_CARD_LAYOUT_DEFAULT = {
    ...
    "ink": "#243B2C", "diffPos": "#C0392B", "diffNeg": "#1F6FB0",
    "date": {"show": True, "x": 990, "y": 150, "align": "right", "size": 34},
    "grid": {"firstColCenterX": 439, "colStep": 157.5, "size": 34,
             "rows": {"distance": 429, "par": 515, "score": 601, "diff": 687}},
}
